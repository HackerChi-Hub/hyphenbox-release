...
- `0.4.7` macOS Apple Silicon（最低 macOS 13）；
...
```text
351a460f4108084803e18f157bac625a4f7b499fdba35fad7fab4081d35c63e7
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.7", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
