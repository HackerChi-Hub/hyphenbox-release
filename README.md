...
- `0.4.14` macOS Apple Silicon（最低 macOS 13）；
...
```text
615910c2ef505626bac0b92836b1454c285a443bce2633487191b50775d436f5
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.14", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
