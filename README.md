...
- `0.4.0` macOS Apple Silicon（最低 macOS 13）；
...
```text
739c34b1796b46f1817f2aff4df446d69ed938ea9b128660dc685707f2d84665
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.0", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
