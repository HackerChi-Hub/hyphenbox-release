...
- `0.4.12` macOS Apple Silicon（最低 macOS 13）；
...
```text
74309b027bd8625684c5913ad428dd9f94158d1d202a8769e413ba7390963dde
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.12", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
