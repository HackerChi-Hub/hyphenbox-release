...
- `0.4.9` macOS Apple Silicon（最低 macOS 13）；
...
```text
f2203b908385927f83f35f0feea2d13d3ddb0bc2d47d23ee04fb95e37fc6a65d
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.9", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
