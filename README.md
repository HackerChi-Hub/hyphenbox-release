...
- `0.4.15` macOS Apple Silicon（最低 macOS 13）；
...
```text
2fc84d6297135c49498e1a7524cdcaaec6ca7ebc428c5b54513116d81d1e742b
```
...
{ "app": "hyphenbox", "device_hash": "<64 位十六进制>",
  "version": "0.4.15", "platform": "macos", "arch": "aarch64", "day": 20694 }
```
